...
def on_up_pressed():
    if True:
        animation.run_image_animation(pla,
            [img("""
                    . . . . . . f f f f . . . . . . 
                                . . . . f f e e e e f f . . . . 
                                . . . f e e e f f e e e f . . . 
...
pla = sprites.create(img("""
    ...
    """),
    SpriteKind.player)
controller.move_sprite(pla)
tiles.set_current_tilemap(tilemap("""
    level9
"""))
scene.camera_follow_sprite(pla)
wow = sprites.create(img("""
        ........................
            ........................
            ........................
            ........................
    ...
    """),
    SpriteKind.enemy)
pla.set_position(135, 120)
wow.follow(pla, 10)
amira = sprites.create(img("""
        . . . . . f f 4 4 f f . . . . . 
            . . . . f 5 4 5 5 4 5 f . . . . 
            . . . f e 4 5 5 5 5 4 e f . . . 
